...
<div class="flex min-h-screen">
    ...
    <main class="flex-grow">
        ...
        <header class="flex items-center justify-between p-6 bg-white shadow-lg">
            ...
            <div class="relative">
                ...
                <div id="profile-menu" class="absolute right-0 mt-2 w-48 bg-white border border-slate-200 rounded-lg shadow-lg hidden">
                    <a href="/blog-raw/admin/profile" class="block px-4 py-2 text-slate-700 hover:bg-slate-100">Profile</a>
                    <a href="/blog-raw/admin/setting" class="block px-4 py-2 text-slate-700 hover:bg-slate-100">Settings</a>
        ...
        <section id="blogs-section" class="p-6">
            ...
            <div class="mb-6">
                <a href="/blog-raw/admin/create" class="px-6 py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-500 transition">Create New Blog</a>
            </div>
