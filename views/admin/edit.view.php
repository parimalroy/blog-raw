        ...
        <section class="p-6">
            <form action="#" method="POST" class="bg-white p-6 rounded-lg shadow-lg">
                <div class="mb-6">
                    ...
                    <input type="text" id="title" name="title" value="How to Build Vue.js Applications"
                ...
                <div class="mb-6">
                    ...
                    <input type="date" id="publish_date" name="publish_date" value="2024-11-15"
                        class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring focus:ring-slate-400"
                        required>
                </div>
                ...
                <div class="flex justify-between items-center">
                    ...
                    <button type="submit"
                        class="px-6 py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-500 transition">Update
                        Blog</button>
                </div>
            </form>
        </section>
