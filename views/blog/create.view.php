...
<div class="flex min-h-screen">
    ...
    <main class="flex-grow">
        ...
        <!-- Blog Creation Form -->
        <section class="p-6">
            <form action="/admin/blog/store-blog" method="POST" enctype="multipart/form-data"
                ...
                <div class="mb-6">
                    ...
                    <p class="text-red-500 text-xl mt-2"><?= $errors['category_id'] ?></p>
                    <?php endif ?>
                </div>
                <div class="mb-6">
                    ...
                    <p class="text-red-500 text-xl mt-2"><?= $errors['cover_photo'] ?></p>
                    <?php endif ?>
                </div>
