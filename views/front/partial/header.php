...
<header class="bg-slate-800 text-white shadow-lg">
    <div class="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav id="menu" class="hidden md:flex space-x-6">
            ...
            <a href="/blog-raw/" class="hover:underline text-slate-300 px-4 py-2 rounded-md <?php echo urls("/blog-raw/")?'bg-slate-700 font-bold text-white':''; ?>">Home</a>

            <a href="/blog-raw/list" class="hover:underline text-slate-300 px-4 py-2 rounded-md <?php echo urls("/blog-raw/list")?'bg-slate-700 font-bold text-white':''; ?>">List</a>
            
            <a href="/blog-raw/details" class="hover:underline text-slate-300 px-4 py-2 rounded-md <?php echo urls("/blog-raw/details")?'bg-slate-700 font-bold text-white':''; ?>">Details</a>
        </nav>
    </div>
